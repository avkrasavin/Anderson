...
# lattice parametrs
Nc=4;Nf=4;Nb=4;L=int(np.sqrt(Nc))
...
def get_start_parametrs(beta,U,mu,t,V):
    ...
    return U+delta_U,mu+delta_mu,t_renorm,V_renorm,hybridization,gamma